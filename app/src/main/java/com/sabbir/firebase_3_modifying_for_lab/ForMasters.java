...
public class ForMasters extends AppCompatActivity {
    ...
    private void getUpdates(DataSnapshot ds) {
        ...
        for (DataSnapshot data : ds.getChildren()) {
            ...
            if (a.equals("Masters")){
                ...
                //Toast.makeText(ForMasters.this, "Got You",Toast.LENGTH_SHORT).show();
            }/*else {
                //descriptions.add(m.getDescription());
                //Toast.makeText(ForMasters.this, year.toString(),Toast.LENGTH_SHORT).show();
                Toast.makeText(ForMasters.this, a, Toast.LENGTH_SHORT).show();
            }*/
        }

        if (descriptions.size() > 0) {
            //ArrayAdapter adapter = new ArrayAdapter(ForAllStudents.this, android.R.layout.simple_list_item_1, year);
            ArrayAdapter adapter = new ArrayAdapter(ForMasters.this, android.R.layout.simple_list_item_1, descriptions);
            lv.setAdapter(adapter);
        }else {
            Toast.makeText(ForMasters.this,"No Data",Toast.LENGTH_SHORT).show();
        }
    }
