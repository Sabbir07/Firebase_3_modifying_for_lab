...
public class ForFourthYear extends AppCompatActivity {
    ...
    private void getUpdates(DataSnapshot ds) {
        ...
        if (descriptions.size() > 0) {
            ArrayAdapter adapter = new ArrayAdapter(ForFourthYear.this, android.R.layout.simple_list_item_1, descriptions);
            lv.setAdapter(adapter);
        }else {
            Toast.makeText(ForFourthYear.this,"No Data",Toast.LENGTH_SHORT).show();
        }
    }
