...
public class ForThirdYear extends AppCompatActivity {
    ...
    private void getUpdates(DataSnapshot ds) {
        ...
        if (descriptions.size() > 0) {
            ArrayAdapter adapter = new ArrayAdapter(ForThirdYear.this, android.R.layout.simple_list_item_1, descriptions);
            lv.setAdapter(adapter);
        }else {
            Toast.makeText(ForThirdYear.this,"No Data",Toast.LENGTH_SHORT).show();
        }
    }
